...
def get_coeff_a(L_HWH, hybrid_category):
    ...
    if hybrid_category == '区分1':
        a_1[L_HWH > 0] = get_table_3()[0][0]
        a_1[L_HWH == 0] = get_table_3()[0][2]
        a_2[L_HWH > 0] = get_table_3()[1][0]
        a_2[L_HWH == 0] = get_table_3()[1][2]
        a_3[L_HWH > 0] = get_table_3()[2][0]
        a_3[L_HWH == 0] = get_table_3()[2][2]
        a_4[L_HWH > 0] = get_table_3()[3][0]
        a_4[L_HWH == 0] = get_table_3()[3][2]
    elif hybrid_category == '区分2':
        a_1[L_HWH > 0] = get_table_3()[0][1]
        a_1[L_HWH == 0] = get_table_3()[0][3]
        a_2[L_HWH > 0] = get_table_3()[1][1]
        a_2[L_HWH == 0] = get_table_3()[1][3]
        a_3[L_HWH > 0] = get_table_3()[2][1]
        a_3[L_HWH == 0] = get_table_3()[2][3]
        a_4[L_HWH > 0] = get_table_3()[3][1]
        a_4[L_HWH == 0] = get_table_3()[3][3]
    else:
...
def get_coeff_b(L_HWH, hybrid_category):
    ...
    b_4 = np.zeros(365)
    if hybrid_category == '区分1':
        b_1[L_HWH > 0] = get_table_4()[0][0]
        b_1[L_HWH == 0] = get_table_4()[0][2]
        b_2[L_HWH > 0] = get_table_4()[1][0]
        b_2[L_HWH == 0] = get_table_4()[1][2]
        b_3[L_HWH > 0] = get_table_4()[2][0]
        b_3[L_HWH == 0] = get_table_4()[2][2]
        b_4[L_HWH > 0] = get_table_4()[3][0]
        b_4[L_HWH == 0] = get_table_4()[3][2]
    elif hybrid_category == '区分2':
        b_1[L_HWH > 0] = get_table_4()[0][1]
        b_1[L_HWH == 0] = get_table_4()[0][3]
        b_2[L_HWH > 0] = get_table_4()[1][1]
        b_2[L_HWH == 0] = get_table_4()[1][3]
        b_3[L_HWH > 0] = get_table_4()[2][1]
        b_3[L_HWH == 0] = get_table_4()[2][3]
        b_4[L_HWH > 0] = get_table_4()[3][1]
        b_4[L_HWH == 0] = get_table_4()[3][3]
    else:
        raise ValueError(hybrid_category)
