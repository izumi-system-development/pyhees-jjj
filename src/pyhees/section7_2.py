...
def calc_E_G_hs_d_t(theta_ex_d_Ave_d, L_dashdash_k_d_t, L_dashdash_s_d_t, L_dashdash_w_d_t, L_dashdash_b1_d_t,
                    L_dashdash_b2_d_t,
                    L_dashdash_ba1_d_t, L_dashdash_ba2_d_t, bath_function, bathtub_filling_method_d_t, hw_type=None, e_rtd=None, e_dash_rtd=None):
    """1時間当たりの給湯機のガス消費量 (5)
    ...
    if bath_function == '給湯単機能':
        # (5-1a)
        E_G_hs_d_t[f1] = L_dashdash_k_d_t[f1] / e_k_d_t[f1] \
    ...
    if bath_function == '給湯単機能':
        # (5-2a)
        E_G_hs_d_t[f2] = L_dashdash_k_d_t[f2] / e_k_d_t[f2] \
...
def get_e_k_d(theta_ex_d_Ave_d, L_dashdash_k_d, L_dashdash_w_d, f_hs):
    ...
    a_std_k = get_table_3()[0][0]
    b_std_k = get_table_3()[1][0]
    c_std_k = get_table_3()[2][0]
    a_k = a_std_k * f_hs
    b_k = b_std_k * f_hs
    c_k = c_std_k * f_hs
...
def get_e_s_d(theta_ex_d_Ave_d, L_dashdash_s_d, f_hs):
    ...
    """
    # 日平均給湯機効率を計算するための回帰係数
    a_std_s = get_table_3()[0][1]
    b_std_s = get_table_3()[1][1]
    c_std_s = get_table_3()[2][1]
    a_s = a_std_s * f_hs
    b_s = b_std_s * f_hs
    c_s = c_std_s * f_hs
...
def get_e_w_d(theta_ex_d_Ave_d, L_dashdash_k_d, L_dashdash_w_d, f_hs):
    ...
    """
    # 日平均給湯機効率を計算するための回帰係数
    a_std_w = get_table_3()[0][2]
    b_std_w = get_table_3()[1][2]
    c_std_w = get_table_3()[2][2]
    a_w = a_std_w * f_hs
    b_w = b_std_w * f_hs
    c_w = c_std_w * f_hs
...
def get_e_b1_d(theta_ex_d_Ave_d, L_dashdash_b1_d, f_hs):
    ...
    """
    # 日平均給湯機効率を計算するための回帰係数
    a_std_b1 = get_table_3()[0][3]
    b_std_b1 = get_table_3()[1][3]
    c_std_b1 = get_table_3()[2][3]
    a_b1 = a_std_b1 * f_hs
    b_b1 = b_std_b1 * f_hs
    c_b1 = c_std_b1 * f_hs
...
def get_e_b2_d(theta_ex_d_Ave_d, L_dashdash_b2_d, f_hs):
    ...
    """
    # 日平均給湯機効率を計算するための回帰係数
    a_std_b2 = get_table_3()[0][4]
    b_std_b2 = get_table_3()[1][4]
    c_std_b2 = get_table_3()[2][4]
    a_b2 = a_std_b2 * f_hs
    b_b2 = b_std_b2 * f_hs
    c_b2 = c_std_b2 * f_hs
...
def get_e_ba1_d(theta_ex_d_Ave_d, L_dashdash_ba1_d, f_hs):
    ...
    """
    # 日平均給湯機効率を計算するための回帰係数
    a_std_ba1 = get_table_3()[0][5]
    b_std_ba1 = get_table_3()[1][5]
    c_std_ba1 = get_table_3()[2][5]
...
def get_e_ba2_d(theta_ex_d_Ave_d, L_dashdash_ba2_d, f_hs):
    ...
    """
    # 日平均給湯機効率を計算するための回帰係数
    a_std_ba2 = get_table_3()[0][6]
    b_std_ba2 = get_table_3()[1][6]
    c_std_ba2 = get_table_3()[2][6]
...
def get_table_3():
    """表3 ガス給湯機効率の回帰係数a_std_u, b_std_u, c_std_u
