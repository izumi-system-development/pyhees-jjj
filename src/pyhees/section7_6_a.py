...
def get_coeff_eq1(hybrid_category):
    ...
    if hybrid_category == '区分1':
        return get_table_3()[0][0], get_table_3()[1][0], get_table_3()[2][0]
    elif hybrid_category == '区分2':
        return get_table_3()[0][1], get_table_3()[1][1], get_table_3()[2][1]
    elif hybrid_category == '区分3':
        return get_table_3()[0][2], get_table_3()[1][2], get_table_3()[2][2]
    else:
...
def get_coeff_eq3(hybrid_category):
    ...
    """
    if hybrid_category == '区分1':
        return get_table_4()[0][0], get_table_4()[1][0], get_table_4()[2][0]
    elif hybrid_category == '区分2':
        return get_table_4()[0][1], get_table_4()[1][1], get_table_4()[2][1]
    elif hybrid_category == '区分3':
        return get_table_4()[0][2], get_table_4()[1][2], get_table_4()[2][2]
    else:
        raise ValueError(hybrid_category)
